...
Reicht der Speicher aus: Max Arbeitssatz...im Vergl zu akt Arbeitssatz
 ...
 Profiler
 Xtended Events
 manuell DMVS wegsichern
 Datensammlung  automtisiert
...
--tu nie neustarten , weil sonst die Messung auf 0 resettet werden
...
---Tipp für Sperren: Read Committed Snapshot
--                   Indizes
